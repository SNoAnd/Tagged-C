...
(* For use with the ConcreteAllocator *)
  ...
  *)
  ...
  | NotHeap 
      ...
      (* @TODO if we expand this to protect the stacka as well, this will need to split into
      StackL & GlobalL *)
  | UnallocatedHeap 
  ...
  | AllocatedPadding (l:loc)(color: Z) 
      (* Malloc can only 8 byte align, but users can ask for any size. From user's perspective this is 
          out of bounds, but not from the allocator's *)
  .
