...
\newcommand{\varstep}
{\judgmentthree{\(\lenv[id] = (l,\_,\pt,ty)\)}
  {\(\trule{\vartres}{\vart}\)}
...
{\judgmenttwo{\(\mathit{boolof}(v) = \mathbf{t}\)}
  {\(\gentag', \vt' \leftarrow \exprsplitt{\gentag}{\vt}\)}
  {\(\defestate{\ctx{\seqand{\val{v}{\vt}}{\expr}}{\gentag}}
  \longrightarrow
...
{\judgment{\(\expr' =
    ...
    \end{cases}\)}
  {\(\gentag' \leftarrow \exprsplitt\)}
  {\(\defestate{\ctx{\condition{\val{v}{\vt}}{\expr_1}{\expr_2}}{\gentag}}
    \longrightarrow
  \defestate{\ctx{\paren{\expr'}{\gentag'}}}{\gentag}\)}}
