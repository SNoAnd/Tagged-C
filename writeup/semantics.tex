...
\newcommand{\callstep}
{\judgmenttwo{\(\mathit{def}(f) = \mathit{INT}(xs, as, \stmt)\)}
  {\(\mem', \lenv' = \mathit{frame} ~ xs ~ (\mathit{zip} ~ as ~ args) ~ \mem ~ \lenv\)}
  {\(\cstate{\PCT}{\mem}{f}{args}{\cont} \longrightarrow
    \sstate{\PCT}{\mem'}{\stmt}{\cont} / \lenv'\)}}

% step_external_function
\newcommand{\extcallstep}
{\judgmentthree{\(\mathit{def}(f) = \mathit{EXT}(spec)\)}
...
{\judgmenttwobrlong
    ...
    {\(\mem'' = \mem'\left[p + i \mapsto (\vundef,\vt,\lt)]_{\mathit{size}}\)}
    {\(\cstate{\PCT}{\mem}{\mathit{malloc}}{(\mathit{size}@t)}{\cont}
      \longrightarrow
      \rstate{\PCT'}{\mem''}{\val{p}{\pt}}{\cont}\)}}

% step_returnstate
\newcommand{\returnstep}
{\judgmenttwo{\(\cont = \mathit{Kcall} ~ \lenv' ~ \mathit{ctx} ~ \PCT_{CLR} ~ \cont'\)}
  {\(\trule{\rettres}{\rett}\)}
  {\(\rstate{\PCT_{CLE}}{\mem}{\val{v}{\vt}}{\cont} \longrightarrow
    \estate{\PCT'}{\mem}{\mathit{ctx}[\val{v}{\vt'}]}{\cont'} / \lenv'\)}}
...
{\judgmenttwo{\(\lenv[id] = \bot\)}
  {\(\genv[id] = \textnormal{\sc var}(l,\_,\pt,ty)\)}
  {\(\var{id}
    \Rightarrow_\lh
    \loc{l}{\pt}\)}}
...
{\judgmenttwobr{\(\neg \mathit{isptr}(\type_1)\)}
  ...
  {\((\PCT,\mem,\cast{(\val{v}{\vt_1}:\type_1)}{\type_2})
    \Rightarrow_\rh
    (\PCT,\mem,\val{v}{\pt}:\type_2)\)}}
...
{\judgmenttwobr{\(\type_1 = \mathit{ptr} ~ \type_1'\)}
  ...
  {\((\PCT,\mem,\cast{(\val{v}{\pt}:\type_1)}{\type_2})
    \Rightarrow_\rh
    (\PCT,\mem,\val{v}{\vt'}:\type_2)\)}}
...
{\judgmenttwo{\(\mathit{boolof}(v) = \mathbf{t}\)}
  ...
  {\((\PCT,\mem,\seqand{(\val{v}{\vt})}{\expr})
  \Rightarrow_\rh
  (\PCT',\mem,\paren{\expr}{\mathit{Tbool}}{\PCT})\)}}
...
{\judgmenttwo{\(\mathit{boolof}(v) = \mathbf{f}\)}
  ...
  {\((\PCT,\mem,\seqand{(\val{v}{\vt})}{\expr})
    \Rightarrow_\rh
    (\PCT',\mem,\paren{(\val{0}{\vt'})}{\mathit{Tbool}}{\PCT})\)}}

% rred_seqor_true
\newcommand{\seqortruestep}
{\judgmenttwo{\(\mathit{boolof}(v) = \mathbf{t}\)}
  {\(\trule{\exprsplittres}{\exprsplitt}\)}
  {\((\PCT,\mem,\seqor{(\val{v}{\vt})}{\expr})
    \Rightarrow_\rh
    (\PCT',\mem,\paren{(\val{1}{\vt'})}{\mathit{Tbool}}{\PCT})\)}}
...
{\judgmenttwo{\(\expr' =
    ...
    \end{cases}\)}
  {\(\trule{\exprsplittres}{\exprsplitt}\)}
  {\((\PCT,\mem,\condition{(\val{v}{\vt})}{\expr_1}{\expr_2})
    \Rightarrow_\rh
    (\PCT',\mem,\paren{\expr'}{}{\PCT}\)}}
...
{\judgmenttwobrlong{\(\mem[l]_{|ty|} = v_1@\vt_1@\overline{\lt}\)}
  ...
  {\((\PCT,\mem,\assign{(\loc{l}{\pt})}{(\val{v_2}{\vt_2})})
    \Rightarrow_\rh
    (\PCT', \mem', \val{v_2}{\vt_2})\)}}

% rred_assignop
\newcommand{\assignopstep}
{\judgmentthreebrlong{\(\mem[l]_{|ty|} = v_1@\vt @\overline{\lt}\)}
  {\(\oplus \in \{+,-,*,/,\%,<<,>>,\&,^\wedge,|\}\)}
  {\(\trule{\loadtres}{\loadt}\)}
...
{\judgmentthreebrlong{\(\mem[l] = v@\vt @\overline{\lt}\)}
  {\(\oplus \in \{+,-\}\)}
  {\(\trule{\loadtres}{\loadt}\)}
...
\newcommand{\commastep}
{\judgment{}
  {\((\PCT,\mem,\comma{(\val{v}{\vt})}{\expr})
    \Rightarrow_\rh
    (\PCT,\mem,\expr)\)}}

% rred_paren
\newcommand{\parenstep}
{\judgment{\(\trule{\exprjointres}{\exprjoint}\)}
  {\((\PCT,\mem,\paren{\expr}{\type}{\PCT'})
    \Rightarrow_\rh
    (\PCT'',\mem,\val{v}{\vt'})\)}}
...
{\judgment{\(\trule{\calltres}{\callt}\)}
  {\(\estate{\PCT}{\mem}{\ctx{\call{\floc{f'}}{\overline{v @ \vt}}}{ty}}{\cont}
    \longrightarrow
    \cstate{\PCT'}{\mem}{f'}{v @ \vt}{\kcall{f}{C}{\PCT}{\cont}}\)}}
