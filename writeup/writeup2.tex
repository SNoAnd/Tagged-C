...
Tagged C is full ordinary C. [TODO: refine this statement!] \amn{Tagged C is a subset 
of conventional C.}
...
A variable expression where the variable is the function {\tt f} evaluates to \(\mathtt{f}\tagat\FN[\mathtt{f}]\).
...
and a memory safety policy. \apt{Probably need to bring back some of the commented text here.}\amn{lost the thread here}
