...
then interleaves all of the advice with its relevant advice points. This is conceptually
very similar to our notion of control points! The main difference is that advice is
...
AOP has been used to implement security systems \cite{} and to extend C in general \cite{}.
...
to failstop. Furthermore, we do not yet have a complete proof of the correctness of our
interpreter, which is a high priority.
