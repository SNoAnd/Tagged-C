...
as part of the CompCert verified compiler \cite{Leroy09:CompCert}\cite{Leroy09:CompCertBackend}.
...
The full formal Tagged C semantics appear in our appendix.
...
it is storing to memory (again ommitting \(\assigntname\)).
...
C runtime verification (RV) systems such as {\sc Rmor}~\cite{Havelund08:RVC} and SLIC~\cite{Ball02:slic}
