...
causing failstops even during normal execution. Sensitive code might call for its own specialized
protection.
...
\(\calltname\) \apt{still don't understand why this doesn't take $\FN$, as in the example}
