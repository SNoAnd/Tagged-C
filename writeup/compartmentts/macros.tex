...
\newcommand{\FN}[1][f]{\mathtt{\color{blue} #1}_{\color{blue} \mathit{fun}}}
\newcommand{\AN}[1][x]{\mathtt{\color{blue} #1}_{\color{blue} \mathit{arg}}}
\newcommand{\GN}[1][x]{\mathtt{\color{blue} #1}_{\color{blue} \mathit{glb}}}
\newcommand{\LN}[1][L]{\mathtt{\color{blue} #1}_{\color{blue} \mathit{lbl}}}
\newcommand{\LNS}{\mathtt{\color{blue} \mathit{lbls}}}
\newcommand{\TN}[1][ty]{\mathtt{\color{blue} #1}_{\color{blue} \mathit{typ}}}
...
\newcommand{\N}{\textnormal{\color{blue} \sc n}}
%% Initial Example %%
\newcommand{\PT}{\mathit{\color{blue} \AN[pwd]}}
\newcommand{\M}{{\color{blue} M}}
%% Memory Safety %%
\newcommand{\clr}[1][c]{\textnormal{\color{blue} \sc clr}{\color{blue}(\mathit{#1})}}
\newcommand{\CAST}{\color{blue} \mathit{CAST}}
...
\newcommand{\pctaint}[1]{\textnormal{\sc \color{blue} pc} \mathit{\color{blue} ~ #1}}
\newcommand{\vol}{\mathit{\color{blue} vol}}
\newcommand{\sink}[1]{\mathit{\color{blue} sink ~ #1}}

%% Tag @ %%
\newcommand{\tagat}{{\color{blue} @}}
...
\newcommand{\kcall}[5]{\mathit{Kcall} ~ #1 ~ #2 ~ #3 ~ #4; ~ #5}
...
\newcommand{\sstate}[4]{\mathcal{S}\left(#2 \mid #3 \gg #4 {\color{blue} \tagat #1}\right)}
\newcommand{\estate}[4]{\mathcal{E}\left(#2 \mid #3 \gg #4 {\color{blue} \tagat #1}\right)}
\newcommand{\cstate}[5]{\mathcal{C}\left(#2 \mid #3(#4) \gg #5 {\color{blue} \tagat #1}\right)}
\newcommand{\rstate}[4]{\mathcal{R}\left(#2 \mid #3 \gg #4 {\color{blue} \tagat #1}\right)}
\newcommand{\fstate}[1]{\mathcal{F}\left(#1\right)}
\newcommand{\sstatefun}[5]{\mathcal{S}\left(#1, #3 \mid #4 \gg #5 {\color{blue} \tagat #2}\right)}

\newcommand{\mem}{m}
\newcommand{\genv}{\mathit{ge}}
\newcommand{\fenv}{\mathit{fe}}
\newcommand{\lenv}{\mathit{le}}
\newcommand{\tenv}{\mathit{te}}
\newcommand{\cont}{k}
\newcommand{\stmt}{s}
\newcommand{\expr}{e}
\newcommand{\type}{ty}
\newcommand{\defestate}[1]
           {\estate{\PCT}{\mem,\lenv,\tenv}{#1}{\cont}}
\newcommand{\defsstate}[1]
           {\sstate{\PCT}{\mem,\lenv,\tenv}{#1}{\cont}}

\newcommand{\Int}{\mathit{int}}
\newcommand{\AL}{\mathit{AL}}
\newcommand{\contents}{\mathit{ctnt}}

%% Expressions $$
\newcommand{\val}[2]{\mathit{Eval} ~ #1\tagat#2}
...
\newcommand{\loc}[2]{\mathit{Eloc} ~ #1\tagat#2}
\newcommand{\floc}[2]{\mathit{Efloc} ~ #1\tagat#2}
