...
Tagged C uses a small-step reduction semantics,  We will introduce
...
We are now forced to consider multiple sources of information, {\tt name} and {\tt sanitize},
as well as multiple information ``sinks,'' {\tt sanitize} and {\tt sql\_query}.
...
[NOTE: Andrew thinks the generalization here is too complicated, so it is going to get cut
  in favor of focusing on the specific sources and sinks just described.]
