...
of tags on values. A value that is tagged \(\mathit{taint} ~ \overline{\sigma}\) has been influnced
...
\(\sigma \not \rightsquigarrow \psi\) is in our IFPol.

We identify sinks through static tags on functions and through memory location tags,
