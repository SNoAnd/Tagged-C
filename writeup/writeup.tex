...
The fact that the input can be sanitized also makes this\apt{what? haven't described the policy yet}  an {\em intransitive} policy:
...
{\tt public2} is tagged \(\high\).\apt{This is confusing integrity and confidentiality.}
