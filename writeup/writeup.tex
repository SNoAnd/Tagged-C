...
\begin{tikzpicture}[every text node part/.style={align=left}]
  \node[matrix, ampersand replacement=\&, anchor=west]
       ...
       \node[node distance=2em, below=of te1.east, draw=blue] (trule1) {\color{blue} \(\storetname\)};
       \node[node distance=2em, below=of te2.east, draw=blue] (trule2) {\color{blue} \(\argtname\)};
...
\begin{tikzpicture}[every text node part/.style={align=left}]
  \node[matrix, ampersand replacement=\&, anchor=west]
       ...
       \node[node distance=1em, above=of t2, draw=blue] (trule0) {\(\color{blue} \consttname\)};
       \node[node distance=2em, below=of te1.east, draw=blue] (trule1) {\color{blue} \(\binoptname\)};
       \node[node distance=2em, below=of te2.east, draw=blue] (trule2) {\color{blue} \(\argtname\)};
...
memory-mapped. The \(\storename\) tag rule now checks the tag on the value being written against
...
\begin{tikzpicture}[every text node part/.style={align=left}]
  \node[matrix, ampersand replacement=\&, anchor=west]
       ...
       \node[node distance=2em, below=of te1.east, draw=blue] (trule1) {\color{blue} \(\storetname\)};
       \node[node distance=2em, right=of pct0.east, draw=blue] (trule0) {\color{blue} \(\splittname\)};
