...
also based on that of CompCert, for executing prototype policies. Tag rules are written directly as Gallina
functions.
...
[TODO: lots of work]
Consider a seemingly straightforward security requirement: ``do not leak the password.''
For simplicity, we will suppose that {\tt passkey} is an integer in this case, and consider
