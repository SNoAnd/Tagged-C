...
The above code is undefined behavior in C. In Tagged C, it is defined in correspondence to
the allocation strategy. {\tt x} and {\tt y} are given concrete addresses, and the program
writes to the address of {\tt x+10}. It's possible that this address is free, in which case
