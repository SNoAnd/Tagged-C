...
following two examples. In the first case, we have some error-handling code that writes
to a log.
...
Our second example involves information from outside of the system ending up somewhere
...
Both examples are instances of problematic information-flow. The solution is to implement
