...
which spares legacy code owners from having to modify their code and potentially introduce regressions.
...
Operating systems (Linux, Windows, OSX, BSD), databases (Oracle, sqlite3), the internet \&
 ...
 C is not a relic; more than a third of professional programmers report active developing
  ...
  where regulations prohibit changes \cite{Bessey10:Coverity}.
...
beyond UB to rule out defined-but-erroneous behaviors that may be difficult to predict.
