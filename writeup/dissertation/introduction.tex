...
This section is comprised of two example policies: a simplified ``spatial'' stack safety
...
sacrifice protection for simplicity, but might due to performance constraints.
