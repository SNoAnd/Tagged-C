...
\newcommand{\FN}[1][f]{{\color{blue} \textnormal{\sc fn}_{#1}}}
\newcommand{\AN}[1][f,x]{{\color{blue} \textnormal{\sc an}_{#1}}}
\newcommand{\GN}[1][x]{{\color{blue} \textnormal{\sc gn}_{#1}}}
\newcommand{\LN}[1][L]{{\color{blue} \textnormal{\sc ln}_{#1}}}
\newcommand{\TN}[1][ty]{{\color{blue} \textnormal{\sc tn}_{#1}}}
