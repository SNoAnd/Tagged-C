...
\newcommand{\malloctres}{\PCT',\pt,\optional{\(\vt\)},\optional{\(\lt\)}}
...
\newcommand{\splittargs}{\PCT, \vt, \optional{\(t\)}}
\newcommand{\splittres}{\PCT', t'}
\newcommand{\splitt}{\splittname(\splittargs)}
           
\newcommand{\jointname}{\mathbf{JointT}}
\newcommand{\jointargs}{\PCT, \optional{\(t\)}}
\newcommand{\jointres}{\PCT', t'}
\newcommand{\joint}{\jointname(\jointargs)}

\newcommand{\argtname}{\mathbf{ArgT}}
\newcommand{\argtargs}{\PCT, \vt, x}
\newcommand{\argtargstyped}{\PCT, \vt, x \in ident}
...
\newcommand{\sstate}[6]{\mathcal{S}\left(#2,#3,#4 \mid #5 \gg #6 @ #1\right)}
\newcommand{\estate}[6]{\mathcal{E}\left(#2,#3,#4 \mid #5; \gg #6 @ #1\right)}
