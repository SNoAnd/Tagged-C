...
\newcommand{\FN}[1][f]{{\color{blue} \textnormal{\sc fn}_{\mathtt{#1}}}}
\newcommand{\AN}[1][f,x]{{\color{blue} \textnormal{\sc an}_{\mathtt{#1}}}}
\newcommand{\GN}[1][x]{{\color{blue} \textnormal{\sc gn}_{\mathtt{#1}}}}
\newcommand{\LN}[1][L]{{\color{blue} \textnormal{\sc ln}_{\mathtt{#1}}}}
\newcommand{\TN}[1][ty]{{\color{blue} \textnormal{\sc tn}_{\mathtt{#1}}}}
