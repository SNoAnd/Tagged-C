...
\newcommand{\FN}[1][f]{\mathit{FN(#1)}}
\newcommand{\AN}[1][f,x]{\mathit{AN(#1)}}
\newcommand{\GN}[1][x]{\mathit{GN(#1)}}
\newcommand{\LN}[1][L]{\mathit{LN(#1)}}
\newcommand{\TN}[1][ty]{\mathit{TN(#1)}}
...
\newcommand{\pctaint}[3]{\mathit{\color{blue} pc ~ #1 ~ #2 ~ #3}}
...
\newcommand{\localtargs}{\PCT, TN(ty)}
...
\newcommand{\dealloctargs}{\PCT, TN(ty)}
