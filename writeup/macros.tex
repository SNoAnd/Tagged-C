...
\newcommand{\CT}{\mathcal{\color{blue} C}}
...
\newcommand{\exprsplittres}{\PCT', \vt'}
\newcommand{\exprsplitt}{\splittname(\splittargs)}
...
\newcommand{\kswitcha}[2]{\mathit{Kswitch1} ~ #1 ~ #2}
\newcommand{\kswitchb}[1]{\mathit{Kswitch2} ~ #1}

\newcommand{\ctx}[2]{ctx \left[#1\right]@#2}

\newcommand{\sstate}[4]{\mathcal{S}\left(#2 \mid #3 \gg #4 @ #1\right)}
\newcommand{\estate}[4]{\mathcal{E}\left(#2 \mid #3 \gg #4 @ #1\right)}
\newcommand{\cstate}[5]{\mathcal{C}\left(#2 \mid #3(#4) \gg #5 @ #1\right)}
\newcommand{\rstate}[4]{\mathcal{R}\left(#2 \mid #3 \gg #4 @ #1\right)}
\newcommand{\fstate}[1]{\mathcal{F}\left(#1\right)}
\newcommand{\sstatefun}[5]{\mathcal{S}\left(#1, #3 \mid #4 \gg #5 @ #2\right)}
