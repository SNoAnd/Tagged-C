...
\begin{figure}[t]
  ...
  \caption{Selected rules for Compartmentalization with Shared Capabilities, combining Compartmentalization rules (\cref{fig:compartments}, subscript \(C\)) with Memory Safety rules (\cref{fig:memsafe}, subscript \(\mathit{MS}\)) (Selected Rules)\apt{Code for $\malloctname$ looks quite wrong to me in the way it unpacks/packs the combined PC tag.}}
  \label{fig:sharing}
\end{figure}
...
\apt{Do you want to mention Faceted IFC to avoid making an enemy of reviewer 2?}
