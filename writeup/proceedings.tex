...
Control points resemble ``advice points'' in aspect-oriented programming, but the ``advice''
...
policy. We will write low-level tags in orange, tags and rules inherited from the high-level
policy, still in blue. This embedding strategy centers around the low-level instruction tags.
Consider the simple function in \cref{fig:compile}, and the result of compiling it to a simplified
