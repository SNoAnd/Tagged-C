...
\author{Sean Anderson \orcidID{0009-0006-7681-3683}
  \and Allison Naaktgeboren \orcidID{0009-0004-0405-9306}
  \and Andrew Tolmach \orcidID{0000-0002-0748-2044} \\
...
\begin{figure}[t]
  \scriptsize
\begin{tikzpicture}[every text node part/.style={align=left}]
  \node[matrix, column sep=0.5em, ampersand replacement=\%, anchor=west] (code)
        {
          \node {\tt 1  int x[1],y[1];}; \%
